using CleanArchitecture_Demo.Application.Features.Players.Commands.CreatePlayer;
using CleanArchitecture_Demo.Shared;
using CleanArchitecture_Demo_Application.Features.Players.Queries.GetPlayersWithPagination;
using MediatR;
